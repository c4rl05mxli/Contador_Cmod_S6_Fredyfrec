...
xst -ifn xst.scr
move reloj_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\reloj_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc reloj_exdes.ucf reloj_exdes

echo 'Running map'
map -timing -pr b reloj_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm reloj_exdes -w routed.ncd routed.vhd
cd ..
